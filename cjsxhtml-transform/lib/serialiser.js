...
Serialiser = (function() {
  ...
  Serialiser.prototype.serialise = function(parseTree) {
    ...
    if domObjectParts.length > 0 and domObjectParts[0] isnt ''
      ...
      @reactObject = 'React'
     */
    this.domObject = this.reactObject = 'jsxhtml';
  ...
  Serialiser.prototype.serialiseSpreadAndPairAttributes = function(children) {
    ...
    return this.reactObject + "(" + (joinList(assignsWithWhitespace)) + ")";
  };
...
nodeSerialisers = {
  ...
  CJSX_EL: function(node) {
    ...
    return this.reactObject + "(" + element + ", " + (joinList(serialisedChildren)) + ")";
  },
